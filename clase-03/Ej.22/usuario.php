<?php
    class Usuario{
        ...
        public static function CargarUsuarios($mostrarUsuarios=true){
            Usuario::$_usuarios=[];
        ...
        public static function ValidarUsuario($clave,$email){
            $retorno=null;

            if(isset($clave) && isset($email) && $clave!="" && $email!=""){
                foreach (Usuario::$_usuarios as $auxUsuario) {
                    if(strcmp($auxUsuario->_clave,$clave)==0 && strcmp($auxUsuario->_email,$email)==0){
                        $retorno="Verificado.";
                    }
                    else if(strcmp($auxUsuario->_clave,$clave)!=0 && strcmp($auxUsuario->_email,$email)==0){
